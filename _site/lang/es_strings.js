i18n.setKeys({
	...
	"General.LoadingAggs": "Cargando Agregaciones...",
	...
	"AliasForm.NewAliasForIndex": "Nuevo Alias para {0}",
	"AliasForm.DeleteAliasMessage": "tipo ''{0}'' para borrar {1}. No hay vuelta atrás",
	"AnyRequest.DisplayOptions" : "Mostrar Opciones",
	"AnyRequest.AsGraph" : "Resultados en Gráfica",
	"AnyRequest.AsJson" : "Mostrar JSON en bruto",
	"AnyRequest.AsTable" : "Mostrar Tabla de Resultados de Búsqueda",
	"AnyRequest.History" : "Histórico",
	"AnyRequest.RepeatRequest" : "Repetir Petición",
	"AnyRequest.RepeatRequestSelect" : "Repetir petición cada ",
	"AnyRequest.Transformer" : "Tranformador de Resultados",
	"AnyRequest.Pretty": "Amigable",
	"AnyRequest.Query" : "Consulta",
	"AnyRequest.Request": "Petición",
	"AnyRequest.Requesting": "Solicitando...",
	"AnyRequest.ValidateJSON": "Validar JSON",
	"Browser.Title": "Navegador",
	"Browser.ResultSourcePanelTitle": "Resultado",
	"Command.DELETE": "BORRAR",
	"Command.SHUTDOWN": "APAGAR",
	"Command.DeleteAliasMessage": "Borrar Alias?",
	"ClusterOverView.IndexName": "Nombre de Índica",
	"ClusterOverview.NumShards": "Número de Shards",
	"ClusterOverview.NumReplicas": "Número de Réplicas",
	"ClusterOverview.NewIndex": "Nuevo Índice",
	"IndexActionsMenu.Title": "Acciones",
	"IndexActionsMenu.NewAlias": "Nuevo Alias...",
	"IndexActionsMenu.Refresh": "Actualizar",
	"IndexActionsMenu.Flush": "Flush",
	"IndexActionsMenu.Optimize": "Optimizar...",
	"IndexActionsMenu.ForceMerge": "ForceMerge...",
	"IndexActionsMenu.Snapshot": "Snapshot de Gateway",
	"IndexActionsMenu.Analyser": "Analizador de Pruebas",
	"IndexActionsMenu.Open": "Abrir",
	"IndexActionsMenu.Close": "Cerrar",
	"IndexActionsMenu.Delete": "Borrar...",
	"IndexInfoMenu.Title": "Info",
	"IndexInfoMenu.Status": "Estado de Índice",
	"IndexInfoMenu.Metadata": "Metadatados de Índice",
	"IndexCommand.TextToAnalyze": "Texto a Analizar",
	"IndexCommand.ShutdownMessage": "tipo ''{0}'' para cerrar {1}. Nodo NO PUEDE ser reiniciado a partir de este interface",
	"IndexOverview.PageTitle": "Vista general de índices",
        "IndexOverview.IndexSize": "Tamaño",
        "IndexOverview.IndexDocs": "Documentos",
	"IndexSelector.NameWithDocs": "{0} ({1} documentos)",
	"IndexSelector.SearchIndexForDocs": "Buscar {0} por documentos donde:",
